class Payment < ActiveRecord::Base
  ...
  def open_todopago(user,curso)
    ...
    optionsSAR_comercio[:URL_OK]= "http://sumemos-uno-mas.herokuapp.com//mark_payment_todopago/"+self.id.to_s+"/OK/payment"
    optionsSAR_comercio[:URL_ERROR]= "http://sumemos-uno-mas.herokuapp.com//mark_payment_todopago/"+self.id.to_s+"/ERROR/payment"
